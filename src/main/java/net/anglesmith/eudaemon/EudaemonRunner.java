...
public class EudaemonRunner implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(EudaemonRunner.class, args);
    }

    public EudaemonRunner(MessageService messageService, ApplicationContext context) {
    ...
    public void run(String... args) {
        ...
        try {
            ...
            JDA jda = new JDABuilder(botToken).addEventListener(new Eudaemon(this.messageService)).build();
            jda.awaitReady();
